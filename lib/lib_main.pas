...
interface
  uses Registry, Winapi.Windows, ShlObj, Terminal, SysUtils;
...
var
  i: Integer;
begin
  Result := True; // ѕредполагаем, что строка числова€ до тех пор, пока не будет найден символ, который это опровергнет
...
//  Reg.WriteString('', 'ќткрыть в TestApplication');
//
