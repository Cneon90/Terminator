@ECHO OFF
REM Copyright (c) 2006, 2022, Oracle and/or its affiliates. All rights reserved. 
REM 
...
:lookup_deregister
IF "%driver_name%" == "" FOR %%d IN (Unicode ANSI) DO CALL :driverLookup "MySQL ODBC 8.1 %%d% Driver"
